    ...
    <form method="post" class="form-x" action="<%=path %>/dispatchCtrl/insertDispatch">
      ...
      <div class="form-group">
        ...
        <div class="field">
          ...
          style="width:25%; float:left" placeholder="请输入维修原因" data-validate="required:请输入维修原因"
      ...
      <div class="form-group">
        ...
        <div class="field">
          ...
          style="width:25%; float:left" placeholder="请输入维修地点" data-validate="required:请输入维修地地点"
          oninput="this.value=this.value.replace(/[^\d]/g,'') " onafterpaste="this.value=this.value.replace(/[^\d]/g,'') "/>
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
       ...
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" name="dispatchReason" value="" 
          style="width:25%; float:left" placeholder="请输入维修金额"/>
          <div class="tips"></div>
        </div>
      </div>
